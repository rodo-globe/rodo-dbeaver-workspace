...
select * from Concepto c where descripcion like "%Reverso aporte patronal%";
...
INSERT INTO Concepto (activo, idBaseLegacy, migrado, observacionesMigracion, version, descripcion, tipo)
VALUES(45, 1, NULL, 0, NULL, '2024-11-25 17:36:47', 'Reverso ajuste por baja afiliado', 1);
...
UPDATE Parametro set creadaDeclaracionJuradaTemplate = 'mailTemplates/declaracion-jurada-creada-para-empresa.html'
ALTER TABLE ParametroMails ADD COLUMN creadaDeclaracionJuradaAsuntoMail VARCHAR(255);
UPDATE Parametro set creadaDeclaracionJuradaAsuntoMail = '[SETS] Se ha credo la Declarción Jurada'

ALTER TABLE ParametroMails ADD COLUMN firmadaDeclaracionJuradaTemplateParaEmpresa VARCHAR(255);
UPDATE Parametro set firmadaDeclaracionJuradaTemplateParaEmpresa = 'mailTemplates/declaracion-jurada-firmada-para-empresa.html'
ALTER TABLE ParametroMails ADD COLUMN firmadaDeclaracionJuradaAsuntoMailParaEmpresa VARCHAR(255);
UPDATE Parametro set firmadaDeclaracionJuradaAsuntoMailParaEmpresa = '[SETS] Declaración Jurada firmada'

ALTER TABLE ParametroMails ADD COLUMN aprobadaDeclaracionJuradaTemplateParaEmpresa VARCHAR(255);
UPDATE Parametro set aprobadaDeclaracionJuradaTemplateParaEmpresa = 'mailTemplates/declaracion-jurada-aprobada-para-empresa.html'
ALTER TABLE ParametroMails ADD COLUMN aprobadaDeclaracionJuradaAsuntoMailParaEmpresa VARCHAR(255);
UPDATE Parametro set aprobadaDeclaracionJuradaAsuntoMailParaEmpresa = '[SETS] Declaración jurada aprobada'

ALTER TABLE ParametroMails ADD COLUMN firmadaDeclaracionJuradaTemplateParaSETS VARCHAR(255);
UPDATE Parametro set firmadaDeclaracionJuradaTemplateParaSETS = 'mailTemplates/declaracion-jurada-firmada-para-SETS.html'
ALTER TABLE ParametroMails ADD COLUMN firmadaDeclaracionJuradaAsuntoMailParaSETS VARCHAR(255);
UPDATE Parametro set firmadaDeclaracionJuradaAsuntoMailParaSETS = '[SETS] Declaración Jurada firmada'

ALTER TABLE ParametroMails ADD COLUMN aprobadaDeclaracionJuradaTemplateParaSETS VARCHAR(255);
UPDATE Parametro set aprobadaDeclaracionJuradaTemplateParaSETS = 'mailTemplates/declaracion-jurada-aprobada-para-SETS.html'
ALTER TABLE ParametroMails ADD COLUMN aprobadaDeclaracionJuradaAsuntoMailParaSETS VARCHAR(255);
UPDATE Parametro set aprobadaDeclaracionJuradaAsuntoMailParaSETS = '[SETS] Declaración Jurada aprobada'

ALTER TABLE ParametroMails ADD COLUMN anuladaDeclaracionJuradaTemplate VARCHAR(255);
UPDATE Parametro set firmadaDeclaracionJuradaAsuntoMailParaEmpresa = 'mailTemplates/declaracion-jurada-anulada-para-empresa.html'
ALTER TABLE ParametroMails ADD COLUMN anuladaDeclaracionJuradaAsuntoMail VARCHAR(255);
UPDATE Parametro set firmadaDeclaracionJuradaAsuntoMailParaEmpresa = '[SETS] Se ha anulado una Declaración Jurada'

ALTER TABLE ParametroMails ADD COLUMN controlMedicoCambioGerenciaTemplate VARCHAR(255);
UPDATE Parametro set controlMedicoCambioGerenciaTemplate = 'mailTemplates/control-medico-cambio-gerencia.html'
ALTER TABLE ParametroMails ADD COLUMN controlMedicoCambioGerenciaAsuntoMail VARCHAR(255);
UPDATE Parametro set controlMedicoCambioGerenciaAsuntoMail = '[SETS] Gerencia ha cambiado el estado de un control médico'